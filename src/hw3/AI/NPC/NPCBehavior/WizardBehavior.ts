...
import { BattlerActiveFilter, EnemyFilter, RangeFilter, ItemFilter, VisibleItemFilter } from "../../../GameSystems/Searching/HW3Filters";
...
import { GuardOptions, GuardStatuses, GuardActions, GuardAction, GuardStatus } from "./GaurdBehavior";

export default class WizardBehavior extends NPCBehavior {

    /** The cooldown on the wizards buff ability */
    protected buffCooldown: Timer;
    /** The range of the wizards buff ability */
